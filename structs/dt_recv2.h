...
//-----------------------------------------------------------------------------
// pStruct = the base structure of the datatable this variable is in (like C_BaseCBaseEntity)
// pOut    = the variable that this this proxy represents (like C_BaseCBaseEntity::m_SomeValue).
//
